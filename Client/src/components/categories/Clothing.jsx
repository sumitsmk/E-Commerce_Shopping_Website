...
function Clothing() {
  ...
  <div className="carousel-inner">
    <div className="carousel-item active">
      <img className="d-block w-100" src="https://ik.imagekit.io/major/images/Screenshot%202023-08-28%20103958.png?updatedAt=1693199430084" alt="First slide"></img>
    </div>
...
<br/><br/>
      ...
      <h1 style={{ textAlign: 'center', margin: 10 }}>Clothing Product Page</h1>
      <div className='row' style={{ marginTop: 50}}>
        {products.map((product) => {
          return (
            <div className='col-md-3'>
              <div className='card'>
              <img  src={`http://localhost:8000/images/${product.productImage}`} style={{ height: 350 }} alt="userimage"/>
